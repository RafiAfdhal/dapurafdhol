                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3 border-bottom pb-2">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <!-- 🔢 Update jumlah -->
                            <form action="{{ route('pelanggan.cart.update', $item->id) }}" method="POST" class="d-flex align-items-center mt-2">
                                @csrf
                                @method('PUT')
                                ...
                                <input type="number" name="jumlah" value="{{ $item->jumlah }}" min="1" max="{{ $item->menu->stok }}"
                                    class="form-control form-control-sm text-center mx-2" style="width: 60px;" readonly>
