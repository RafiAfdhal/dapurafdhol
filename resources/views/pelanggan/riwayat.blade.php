            ...
            <tbody>
                @forelse($orders as $order)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('pelanggan.riwayat.detail', $order->id) }}" class="btn btn-sm btn-success mb-1">
                                <i class="bi bi-eye"></i> Detail
                            </a>

                            @if ($order->status === 'pending')
                                <form action="{{ route('pelanggan.riwayat.cancel', $order->id) }}" method="POST" class="d-inline"
                            ...
                            @if ($order->status === 'pengiriman')
                                <form action="{{ route('pelanggan.riwayat.terima', $order->id) }}" method="POST" class="d-inline"
                            ...
                            @if (in_array($order->status, ['selesai', 'cancel']))
                                <form action="{{ route('pelanggan.riwayat.destroy', $order->id) }}" method="POST" class="d-inline"
