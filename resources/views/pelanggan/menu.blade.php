                ...
                <div class="col menu-item">
                    <div class="menu-card">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <a href="{{ route('pelanggan.ulasan', $menu->id) }}" class="d-flex align-items-center mb-2 text-decoration-none">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-auto item-actions">
                                <div>
                                    <span class="item-price d-block">Rp {{ number_format($menu->harga, 0, ',', '.') }}</span>
                                ...
                                <div class="d-flex align-items-center action-buttons">
                                    @if($menu->stok > 0)
                                    <a href="{{ route('pelanggan.checkout', $menu->id) }}" class="btn btn-add-to-cart">Pesan</a>
                                    <form action="{{ route('pelanggan.cart.add', $menu->id) }}" method="POST" class="d-inline">
                                        @csrf
