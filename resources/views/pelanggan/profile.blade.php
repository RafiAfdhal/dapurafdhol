    ...
    <div class="container py-5">
        ...
        <div class="card shadow-lg mx-auto" style="max-width: 700px; border-radius: 20px;">
            <div class="card-body text-center">
                ...
                {{-- FORM PROFIL --}}
                <form id="profileForm" action="{{ route('pelanggan.profile.update') }}" method="POST"
        ...
        <div class="text-center mt-5">
            ...
            <div class="d-flex justify-content-center gap-3 fs-3">
                <a href="https://www.instagram.com/dapurafdhol" target="_blank" class="text-danger"><i
                        class="fab fa-instagram"></i></a>
                <a href="https://www.facebook.com/dapurafdhol" target="_blank" class="text-primary"><i
                        class="fab fa-facebook"></i></a>
                <a href="https://www.tiktok.com/@dapurafdhol" target="_blank" class="text-dark"><i
