            ...
            <table class="table table-borderless table-custom">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($menu->gambar)
                            <img src="{{ Storage::url($menu->gambar) }}" alt="{{ $menu->nama }}" class="menu-thumbnail">
                            @else
                            <img src="https://placehold.co/60x60/888888/ffffff?text=No+Img" class="menu-thumbnail">
                            @endif
                        </td>
                        <td>{{ $menu->nama }}</td>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ route('admin.menu.edit', $menu->id) }}" class="btn btn-sm btn-outline-secondary me-1">
