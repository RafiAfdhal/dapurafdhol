...
@section('content')
@include('layouts.admin.cssprofile')
        ...
        <div class="card-body text-center">
            ...
            <div class="mb-4">
                ...
                <div class="mt-3">
                    ...
                    {{-- Hapus Foto --}}
                    @if($user->profile_photo_path)
                    <form action="{{ route('admin.profile.deletePhoto') }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
            ...
            {{-- FORM PROFIL --}}
            <form id="profileForm" action="{{ route('admin.profile.update') }}" method="POST" enctype="multipart/form-data" class="text-start">
                @csrf
                @method('PUT')
